...
void instructions() {
    ...
    switch (gameStats.instruction) {
        ...
        case 2:
            ...
            Sprites::drawOverwrite(0, 27, Images::Tiles, 5);
            font3x5.setCursor(10, 27);
